...
const CartPage = () => {
    ...
    const handleRemoveFromCart=(oldproduct)=>{
        dispatch(removeFromCart(oldproduct))
    }
  ...
  return (
    <>
    <div className="flex mt-12 h-full flex-col overflow-hidden bg-white shadow-xl px-16">
