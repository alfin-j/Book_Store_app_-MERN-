...
const News = () => {
  ...
  return (
    <div className='py-16'>
        <h2 className='text-3xl font-semibold mb-6 text-white text-center'>News</h2>
        <Swiper
                slidesPerView={1}
                spaceBetween={30}
                navigation={true}
            ...
            news.map((item, index) => (
                <SwiperSlide key={index}>
                    <div className='flex flex-col sm:flex-row sm:justify-between items-center gap-12'>
                        ...
                        <div className='py-4'>
                            <Link to="/">
                                 <h3 className='text-lg font-medium hover:text-blue-500 mb-4 text-white'>{item.title}</h3>
                            </Link>
